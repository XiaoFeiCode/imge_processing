...
from image_class import classification_config
from image_class import classification_model
from image_similiar import similarity_config  # 配置文件
from image_similiar import similarity_model  # 自定义模型模块
